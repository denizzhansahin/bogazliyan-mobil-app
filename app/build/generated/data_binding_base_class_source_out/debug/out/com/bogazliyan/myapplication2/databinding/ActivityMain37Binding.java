...
public final class ActivityMain37Binding implements ViewBinding {
  @NonNull
  ...
  private ActivityMain37Binding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ActivityMain37Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityMain37Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_main37, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static ActivityMain37Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMain37Binding((ConstraintLayout) rootView, imageButton1, imageButton2,
          imageButton3, imageButton4, scrollView2);
    }
