...
public final class ActivityMain14Binding implements ViewBinding {
  ...
  private ActivityMain14Binding(@NonNull ConstraintLayout rootView, @NonNull Button button55,
  ...
  public static ActivityMain14Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.button55;
      Button button55 = ViewBindings.findChildViewById(rootView, id);
      if (button55 == null) {
        break missingId;
      }
      ...
      return new ActivityMain14Binding((ConstraintLayout) rootView, button55, imageView3,
