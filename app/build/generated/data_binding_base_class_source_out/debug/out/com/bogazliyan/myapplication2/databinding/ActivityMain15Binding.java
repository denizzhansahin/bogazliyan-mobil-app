...
public final class ActivityMain15Binding implements ViewBinding {
  ...
  private ActivityMain15Binding(@NonNull ConstraintLayout rootView, @NonNull Button button56,
  ...
  public static ActivityMain15Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.button56;
      Button button56 = ViewBindings.findChildViewById(rootView, id);
      if (button56 == null) {
        break missingId;
      }
      ...
      return new ActivityMain15Binding((ConstraintLayout) rootView, button56, imageView3,
